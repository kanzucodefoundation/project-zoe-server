...
import {createGroupRules, editGroupRules} from "../dto/rules";
...
/* Create */
router.post("/", createGroupRules, validate, async (req: Request, res: Response) => {
    try {
...
/* Update */
router.put("/", editGroupRules, validate, async (req: Request, res: Response) => {
    try {
