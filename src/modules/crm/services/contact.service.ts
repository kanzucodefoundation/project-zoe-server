...
import {dataToContact} from "../dto/contact.dto";
...
import {ContactQuery} from "../../../data/ContactQuery";
...
// TODO Add validation
export const createAsync = async (data: any): Promise<Contact> => {
    return await repo().save(data);
};

export const searchAsync = async (q: ContactQuery): Promise<Contact[]> => {
...
export const createQuery = (q: BaseQuery) => {
    const filter: any = {};
    if (hasValue(q.query)) {
